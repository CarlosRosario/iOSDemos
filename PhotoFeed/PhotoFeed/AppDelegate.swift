...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        let urlString = "https://api.flickr.com/services/feeds/photos_public.gne?tags=kitten&format=json&nojsoncallback=1"
        print(urlString)
...
//    func updatedFeed(url: NSURL, completion: (feed: Feed?) -> Void) {
